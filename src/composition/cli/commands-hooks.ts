...
import { stopHookPorts } from "../hooks/stop-adapters.js";
import { hookUserPrompt } from "../../interfaces/hooks/user-prompt.js";
import { sessionHookPorts, sessionSummaryPorts, userPromptDeps } from "../hooks/session-adapters.js";
import {
  migrationGuardPorts,
  packageGuardPorts,
  postWriteGuardPorts,
  scopeGuardPorts,
  secretScanPorts,
} from "../hooks/guard-adapters.js";
import { postHookPorts } from "../hooks/adapters.js";
import { preHookPorts } from "../hooks/pre-adapters.js";
