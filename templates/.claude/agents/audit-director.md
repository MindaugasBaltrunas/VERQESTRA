...
Per **Read tool** perskaityk `README.md` ir `docs/architecture.md` — taip PostToolUse
...
1. Paleisk projekto realias patikros komandas (iš README / `package.json` scripts / `vq/project/profile.json` quality_gates — pvz. build, typecheck, lint, test). Nehardcode'ink — naudok tai, ką projektas turi.
...
Visos patikros praeina → `vq/logs/commit-msg.md` · architektūrinis sprendimas reikalingas → aprašyk ir sustok.
